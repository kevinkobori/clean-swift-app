...
class RemoteAddAccountTests: XCTestCase {
    ...
    func test_add_should_complete_with_account_if_client_conpletes_with_valid_data() throws {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_add_should_complete_with_error_if_client_conpletes_with_invalid_data() throws {
        let (sut, httpClientSpy) = makeSut()
        expect(sut, completeWith: .failure(.unexpected), when: {
